...
def save_library(library):
    with open(data_file, 'w') as file:
        json.dump(library, file, indent=4)  # Pretty JSON format
...
def display_statistics(library):
    ...
    if total_books == 0:
        ...
        return  # Direct return to avoid ZeroDivisionError
...
def main():
    ...
    while True:
        ...
        print("Menu")  # Fixed spelling mistake
        print("1. Add a book")
        ...
        if choice == '1':
            ...
            library = remove_book(library)  # Update library after removing book
        elif choice == '3':
